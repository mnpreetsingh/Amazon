...
rightbtn.addEventListener("click", function(event) {
    const consent = document.querySelector('.product-slide');
    consent.scrollLeft += 1100;
...
rightbtn1.addEventListener("click", function(event) {
    const consent = document.querySelector('.product-slide-1');
    consent.scrollLeft += 1100;
    event.preventDefault();
})
...
rightbtn2.addEventListener("click", function(event) {
    const consent = document.querySelector('.product-slide-2');
    consent.scrollLeft += 1100;
    event.preventDefault();
})
...
rightbtn3.addEventListener("click", function(event) {
    const consent = document.querySelector('.product-slide-3');
    consent.scrollLeft += 1100;
    event.preventDefault();
})
